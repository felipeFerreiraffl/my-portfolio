...
```
Agent(
  prompt="Read /home/felipe_ffl/dev/projects/my-portfolio/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/felipe_ffl/dev/projects/my-portfolio/.claude/gsd-core/templates/VALIDATION.md`
