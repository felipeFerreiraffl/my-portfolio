...
- **Global scope**: `/home/felipe_ffl/dev/projects/my-portfolio/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/felipe_ffl/dev/projects/my-portfolio/.claude/notes/`)
...
2. Glob `/home/felipe_ffl/dev/projects/my-portfolio/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/felipe_ffl/dev/projects/my-portfolio/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/felipe_ffl/dev/projects/my-portfolio/.claude/notes/` — works in any directory
