...
<!-- For checkpoint task examples and patterns, see @/home/felipe_ffl/dev/projects/my-portfolio/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/felipe_ffl/dev/projects/my-portfolio/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/felipe_ffl/dev/projects/my-portfolio/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/felipe_ffl/dev/projects/my-portfolio/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
