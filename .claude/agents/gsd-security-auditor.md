...
**Verification depth scales with `asvs_level`** (see @/home/felipe_ffl/dev/projects/my-portfolio/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
