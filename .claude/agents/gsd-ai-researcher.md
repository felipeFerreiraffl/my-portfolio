...
<required_reading>
Read `/home/felipe_ffl/dev/projects/my-portfolio/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
